...
class Settings(BaseSettings):
    ...
    GOOGLE_SECRET_MANAGER_PROJECT: str | None = None
    CLOUD_SCHEDULER_OIDC_AUDIENCE: str | None = None
    CLOUD_SCHEDULER_SERVICE_ACCOUNT_EMAIL: str | None = None
    CLOUD_SCHEDULER_SERVICE_ACCOUNT_EMAIL_SECRET_ID: str | None = None
    CLOUD_SCHEDULER_SERVICE_ACCOUNT_EMAIL_SECRET_VERSION: str = "latest"
